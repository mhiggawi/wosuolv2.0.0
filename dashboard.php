<?php
// dashboard.php - Enhanced with languages and improved functionality - FIXED VERSION
session_start();
...
if (isset($_GET['fetch_data'])) {
    ...
    // Calculate statistics to send with the guests data
    $stats = [
...
<head>
    ...
    <style>
        ...
        /* حاويات قوائم الضيوف بالتصميم الموحد - FIXED SCROLLING */
        ...
        .guest-list-container::-webkit-scrollbar-thumb:hover {
        ...
        .guest-list-container {
            ...
            scrollbar-color: rgba(45, 74, 34, 0.3) rgba(45, 74, 34, 0.1);
        }
    ...
    <script>
        ...
        guestSearchInput.addEventListener('input', () => {
            ...
            if (searchTerm.length === 0) {
                isSearching = false;
                filteredGuestsData = allGuestsData;
                updateDashboard(allGuestsData, true); // Don't use previousStats when resetting, recalculate everything
            } else {
